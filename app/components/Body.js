...
const Body = (props) => {
	return (
		<div className="body">
			...
			<p>When I'm not at work I like to indulge in my other interests. Going to gigs, playing music, <a href="//www.instagram.com/robinpwest/" target="_blank">drawing things</a>, taking photos, watching horror movies, playing computer games or having a beer with my pals.</p>
		</div>
	);
}
